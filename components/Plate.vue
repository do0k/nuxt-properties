...
const arr = computed(() => props.number.replace('ایران/', '').split(/\D/))
...
<template lang="pug">
.shadow-md.border.border-slate-500.rounded.flex.items-center.justify-center.w-28.h-6.overflow-y-hidden(:class="bg")
  .border-r.border-slate-500.px-1.text-center.w-7.iran-bg
    span.font-bold.relative.top-1(v-show="arr[0]") {{ arr[0] }}
  .text-sm.p-1.flex-1.text-center.flex.font-bold
